...
class Link(models.Model):
    ...
    weight = models.PositiveIntegerField(default=1, choices=zip(range(1, 6), range(1, 6)), verbose_name='权重', help_text='权重展示顺序靠前')
...
class SideBar(models.Model):
    ...
    def content_html(self):
        ...
        if self.display_type == self.DISPLAY_HTML:
            ...
            res = render_to_string('config/blocks/sidebar_posts.html', context)
            ...
            res = render_to_string('config/blocks/sidebar_comments.html', context)
        return res
